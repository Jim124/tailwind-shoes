export function Sidebar({ children, isOpen, onCloseSidebar }) {
  return (
    <div>
      <div
        className={`dark:bg-night p-5 z-50 overflow-y-auto fixed top-0 right-0 h-full w-full shadow-lg md:w-[50%] lg:md-[35%] bg-white transition transform duration-300 ${isOpen ? 'translate-x-0' : 'translate-x-full'} `}
      >
        <div>
          <button
